...
var searchArray = function (arrayToSearch, query) {
    if (query.length === 2 && arrayToSearch.every(subArray => 
        Array.isArray(subArray) && subArray.length === 2)) {
        ...
        throw new Error('Invalid input: query must have exactly 2 elements and arrayToSearch must be a 2D array with sub-arrays of length 2.');
    }
};
